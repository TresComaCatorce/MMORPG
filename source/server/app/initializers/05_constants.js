...
module.exports = Constants = {
	...
	PACKETS: {
		...
		C_LOGIN: 'C_LOGIN',
		C_CHARACTER_CONNECT: 'C_CHARACTER_CONNECT',
		C_REGISTER: 'C_REGISTER',
		C_UPDATE: 'C_UPDATE',
		S_CHAT_MSG: 'S_CHAT_MSG',
		S_CHAT_MSG_SPREAD: 'S_CHAT_MSG_SPREAD',
		S_CON_CHECK: 'S_CON_CHECK',
		S_LOGIN_SUCCESS: 'S_LOGIN_SUCCESS',
		S_LOGIN_FAILURE: 'S_LOGIN_FAILURE',
		...
		S_ENEMY_SPAWN: 'S_ENEMY_SPAWN',
		S_ENEMY_UPDATE: 'S_ENEMY_UPDATE',
		S_ENEMY_DEATH: 'S_ENEMY_DEATH'
	},
	STATES: {
		CHARACTER: {
			IDLE: 'C_IDLE',
